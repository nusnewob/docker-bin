...
RUN curl -L -o /opt/docker/docker-compose "https://github.com/docker/compose/releases/download/1.8.0/docker-compose-`uname -s`-`uname -m`" && chmod +x /opt/docker/docker-compose
VOLUME /opt/docker
